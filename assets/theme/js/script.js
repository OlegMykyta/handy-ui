...
$jscomp.polyfill = function (b, h, e, q) {
    if (h) {
        ...
        q = e[b];
        h = h(q);
        h != q && null != h && $jscomp.defineProperty(e, b, {configurable: !0, writable: !0, value: h})
    }
};
$jscomp.polyfill("Array.from", function (b) {
    return b ? b : function (b, e, q) {
        ...
        var h = [], m = "undefined" != typeof Symbol && Symbol.iterator && b[Symbol.iterator];
        if ("function" == typeof m) {
            b = m.call(b);
            for (var r = 0; !(m = b.next()).done;) h.push(e.call(q, m.value, r++))
        } else for (m = b.length, r = 0; r < m; r++) h.push(e.call(q, b[r], r));
        return h
    }
}, "es6", "es3");
...
(function () {
    ...
    function I(a) {
        var c = "", d = a.querySelector("svg linearGradient");
        if (d) {
            c = [];
    ...
    function D(a) {
        var c = a.closest("section").getAttribute("id") + "-svg-gradient", d = +a.getAttribute("data-goal");
        z(a, c, d)
    }
    ...
    function J(a, c) {
        if (a.classList.contains("circle-progress-section") && c.includes("progress") && "progressCount" != c) if (c.includes("Color")) a.querySelectorAll(".pie_progress").forEach(function (c) {
            var b = a.getAttribute("id") + "-svg-gradient", d = +c.getAttribute("data-goal");
            z(c, b, d)
        }); else {
    ...
    function E() {
        if (document.querySelector(".loop-container")) {
            var a = function (c) {
                var b = 0, g = 0, k = +c.children[0].dataset.speed || .05, e = c.querySelector(".item"),
                ...
                if (e) {
                    ...
                    l.observe(e, {attributes: !0, attributeFilter: ["data-direction", "data-speed", "data-linewords"]});
                    (function () {
    ...
    Element.prototype.footerReveal = function () {
        ...
        var c = this, b = c.previousElementSibling, g = !!document.documentMode;
        a();
    ...
    var K = function () {
        var a = document.createElement("div"), c = document.querySelector("body");
    ...
    l(function () {
        ...
        function c(a) {
            setTimeout(function () {
                b(a, ".mbr-parallax-background").forEach(function (a) {
                    jarallax &&
                    (jarallax(a, {speed: .6}), a.style.position = "relative")
                })
            }, 0)
        }
        ...
        function d(a) {
            b(a, "[data-bg-video]").forEach(function (a) {
                ...
                if (c) {
                    var b = new URLSearchParams(c), d = Number(b.has("t") ? b.get("t") : 0) || 0,
                    ...
                    if (k && (/youtu\.?be/g.test(k[3]) || /vimeo/g.test(k[3]))) if (k && /youtu\.?be/g.test(k[3])) {
                        ...
                        t.onload = function () {
                            ...
                            var c = document.createElement("div"), f = document.createElement("div"),
                            ...
                            var h = t.naturalHeight, p = t.naturalWidth, G = t.naturalHeight / t.naturalWidth,
                                l = b.parentNode.clientHeight, C = b.parentNode.clientWidth;
                            h = h < l ? h : l;
                            p = p > C ? p : C;
                            h / p != G && (h = p * G);
                        ...
                        muted: !0,
                        controls: !1
                    }), b = c.element.parentNode, b.style.overflow = "hidden", c.element.style.pointerEvents = "none", c.element.style.marginLeft = "-" + (c.element.scrollWidth - b.scrollWidth) / 2 + "px", c.element.style.minHeight = "100vh", c.element.style.minWidth = "177.77vh"); else if (n) g.style.backgroundImage = 'url("images/video-placeholder.jpg")', g.style.display =
                        "block"; else if (!n) {
        ...
        document.querySelectorAll(".cols-same-height .mbr-figure").forEach(function (a) {
            ...
            var c = a.querySelector("img"), d = a.parentNode, k = c.width,
                g = c.height;
        ...
        if (!n) {
            ...
            document.querySelectorAll(".modalWindow-video > iframe").forEach(function (a) {
                ...
                if (b) {
                    ...
                    if (-1 !== b.indexOf("youtu")) a.setAttribute("src", "https://youtube.com/embed/" + c[6] + "?rel=0&enablejsapi=1"); else if (-1 !== b.indexOf("vimeo")) a.setAttribute("src", "https://player.vimeo.com/video/" +
    ...
    if (n) {
        ...
        f(document).on("add.cards", function (a) {
            ...
            (a = f(a.target).find(".form-with-styler"), f(a).find('select:not("[multiple]")').each(function () {
                ...
                f(this).datetimepicker && f(this).datetimepicker({format: "Y-m-d", timepicker: !1})
    ...
    if (n) f(document).on("add.cards", E); else window.addEventListener("DOMContentLoaded", E);
    if (n) f(document).on("add.cards", F); else window.addEventListener("DOMContentLoaded", F)
})();
